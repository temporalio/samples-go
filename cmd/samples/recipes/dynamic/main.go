...
func startWorkers(h *common.SampleHelper) {
	...
	worker.RegisterWorkflow(SampleGreetingsWorkflow)
	worker.RegisterActivity(getGreetingActivity)
	worker.RegisterActivity(getNameActivity)
	worker.RegisterActivity(sayGreetingActivity)
}
