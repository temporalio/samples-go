...
1) Start the [Temporal dev server build that supports standalone Nexus operations](https://github.com/temporalio/cli/releases/tag/v1.7.3-standalone-nexus-operations) with the required dynamic config and both namespaces pre-created:
